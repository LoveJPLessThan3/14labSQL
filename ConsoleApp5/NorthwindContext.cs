...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<Award1997> Award1997s { get; set; }
    ...
    public virtual DbSet<FirstPoint> FirstPoints { get; set; }

    public virtual DbSet<FourthTask> FourthTasks { get; set; }
    ...
    public virtual DbSet<SecondPoint> SecondPoints { get; set; }
    ...
    public virtual DbSet<ThirdPoint> ThirdPoints { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseNpgsql("Host=localhost;Port=5432;Database=northwind;Username=postgres;Password=1");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Award1997>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("award_1997");
        ...
        modelBuilder.Entity<FirstPoint>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("first_point");
        ...
        modelBuilder.Entity<FourthTask>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("fourth_task");
        ...
        modelBuilder.Entity<ProductsAudit>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("products_audit");

            entity.Property(e => e.LastDate)
                .HasColumnType("timestamp without time zone")
                .HasColumnName("last_date");
            entity.Property(e => e.NewUnitPrice).HasColumnName("new_unit_price");
        ...
        modelBuilder.Entity<SecondPoint>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("second_point");
        ...
        modelBuilder.Entity<ThirdPoint>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("third_point");
        ...
        modelBuilder.Entity<TmpCustomer>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("tmp_customers");
